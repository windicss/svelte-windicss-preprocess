 (() => new EventSource("/esbuild").onmessage = (e) => location.reload())();
...
function create_fragment(ctx) {
  ...
  const block = {
    c: function create() {
      ...
      attr_dev(button, "class", "bg-light-600");
      add_location(button, file, 4, 0, 21);
    },
...
function create_fragment2(ctx) {
  ...
  const block = {
    c: function create() {
      ...
      attr_dev(div, "class", "bg-gray-50");
      add_location(div, file2, 5, 0, 62);
    },
    l: function claim(nodes) {
      throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    },
...
// src/index.js
var src_default = new App_default({
